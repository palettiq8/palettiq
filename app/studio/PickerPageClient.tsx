    ...
    <>
      <div className="w-full h-full shadow-[0px_0px_12px_0px_rgba(0,0,0,0.1)] bg-white rounded-xl">
        <div className="w-full h-16 px-4 border-b border-gray-200 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              aria-label="Export selected color in HEX, RGB, HSL, CMYK and other formats"
              onClick={() => {
                toggleExportModel();
                setExportFrom("Color");
            ...
            <Button
              aria-label="Generate random color for color picker"
      ...
      <section className="sr-only">
        ...
        <p>
          ...
          HSV, HWB, CMYK, LAB, LCH, and XYZ color formats.
        </p>

        <p>
          Explore color harmonies including analogous, monochromatic,
          complementary, split complementary, tetradic, and triadic palettes.
        </p>

        <p>
          Generate color tints, shades, and tones for UI design, web design,
          branding, marketing assets, illustrations, and digital products.
        </p>

        <p>
          Copy color values, export colors, save color history, and build
          professional color systems directly in your browser.
        </p>
      </section>
    </>
  );
