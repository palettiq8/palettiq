    ...
    <>
      <div className="w-full h-full shadow-[0px_0px_12px_0px_rgba(0,0,0,0.1)] bg-white rounded-xl">
        <div className="w-full h-16 px-4 border-b border-gray-200 flex items-center justify-between">
          ...
          <Button
            aria-label={`Export ${activeShadowTab === "Box Shadow" ? "box shadow" : "text shadow"} CSS code`}
            onClick={() => {
                ...
                <div className="w-full">
                  ...
                  <div className="w-full p-4">
                    <ShadowAddLayerContainer
                      handler={addBoxShadowLayerHandler}
                    />
                  </div>
      ...
      <div className="sr-only">
        <h2>About CSS Shadow Generator</h2>

        <p>
          Create CSS box shadows and text shadows visually with PalettIQ's free
          CSS Shadow Generator. Adjust blur radius, spread radius, horizontal
          and vertical offsets, shadow color, opacity, and inset effects to
          build custom shadows for websites and applications.
        </p>

        <p>
          Generate multiple layered shadows, preview changes in real time,
          switch between container and output views, and copy production-ready
          CSS code instantly. Perfect for UI designers, frontend developers, and
          design systems.
        </p>
      </div>
    </>
