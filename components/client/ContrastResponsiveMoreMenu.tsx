...
export default function ContrastResponsiveMoreMenu() {
  ...
  return (
    <div className="relative">
      ...
      >
        <button
          className={`w-8.5 h-8.5 cursor-pointer rounded-full border grid place-content-center ${contrastResponsiveMoreMenu ? "bg-gray-100 border-gray-200" : "border-white"}`}
        >
          <LuEllipsisVertical
            size={17}
            aria-hidden="true"
