            ...
            {gradientViewDetailsModel && (
                ...
                >
                    <motion.div
                        ...
                        className="w-125 h-max bg-white rounded-xl shadow-2xl relative max-sm:w-full"
                    >
                        <div className="w-full p-3 bg-gray-100 border-b border-gray-200 rounded-t-xl">
                            <div className="w-full h-full border-2 border-white rounded-lg shadow-sm">
                                <div className="w-full h-50 first:rounded-l-lg last:rounded-r-lg" style={{
                        ...
                        <div className="w-full flex items-center justify-between p-3">
                            <div className="w-max flex flex-col items-start gap-2">
                                <h3 className="text-xs font-semibold text-gray-500">Gradient Name</h3>
                        ...
                        <div className="w-full flex items-start gap-3 px-3">
                            <LuFileText size={16} aria-hidden="true" className="shrink-0 mt-0.5" />
