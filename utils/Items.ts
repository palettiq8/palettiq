...
export const headerLinkItems = [
  ...
  { id: 2, title: "Colors", url: "/explore/colors" },
  { id: 3, title: "Gradients", url: "/explore/gradients" },
  { id: 4, title: "Fonts", url: "/explore/fonts" },
];
export const features = [
  {
    id: 1,
    title: "Generator",
    urlTitle: "Generate palette",
    icon: LuGrid2X2,
    desc: "Create perfectly balanced color palettes instantly.",
  ...
  },
  {
    id: 2,
    title: "Ai Generator",
    urlTitle: "Generate Ai Palette",
    icon: LuSparkles,
    desc: "Create stunning color palettes instantly with AI-powered suggestions.",
  ...
  },
  {
    id: 3,
    title: "Picker",
    urlTitle: "Pick a color",
    icon: LuPencil,
    desc: "Select precise colors and adjust them easily to match your design needs.",
  ...
  },
  {
    id: 4,
    title: "Gradient",
    urlTitle: "Generate gradient",
    icon: LuCircleDot,
    desc: "Create beautiful gradients instantly with our gradient generator.",
  ...
  },
  {
    id: 5,
    title: "Extractor",
    urlTitle: "Extract color",
    icon: LuPickaxe,
    desc: "Extract stunning color palettes from any image instantly.",
  ...
  },
  {
    id: 6,
    title: "Contrast",
    urlTitle: "Check contrast",
    icon: LuContrast,
    desc: "Ensure perfect readability with our color contrast checker.",
  ...
  },
  {
    id: 7,
    title: "Visualizer",
    urlTitle: "Visualize palette",
    icon: LuActivity,
    desc: "Bring your palette into context and see exactly how it works before shipping.",
  ...
  },
  {
    id: 8,
    title: "Shadow",
    urlTitle: "Generate shadow",
    icon: LuDroplet,
    desc: "Create realistic, customizable shadows that add depth and elevate your designs.",
...
export const footerItems = [
  ...
  { id: 12, title: "Explore fonts", url: "/explore/fonts" },
  { id: 13, title: "About us", url: "/about-us" },
  { id: 14, title: "Help center", url: "/help-center" },
  { id: 15, title: "Feedback", url: "/settings/feedback" },
  { id: 16, title: "Facebook", url: "#" },
  { id: 17, title: "Instagram", url: "#" },
  { id: 18, title: "Linkedin", url: "#" },
  { id: 19, title: "Twitter / X", url: "#" },
  { id: 20, title: "Terms & conditions", url: "/terms-and-conditions" },
  { id: 21, title: "Privacy policy", url: "/privacy-policy" },
  { id: 22, title: "Cookie policy", url: "/cookie-policy" },
];
...
export const generatorContentHeaderMoreItems = [
  { id: 1, title: "Copy", icon: LuCopy },
  { id: 2, title: "View mode", icon: LuShrink },
  { id: 3, title: "Make gradient", icon: LuCircleDot },
  { id: 4, title: "Visualize the palette", icon: LuActivity },
];
export const colorFamilies: Record<string, ColorFamily> = {
  ...
  Lime: { hue: [70, 85], sat: [60, 100], light: [30, 80] },
  Green: { hue: [90, 150], sat: [60, 100], light: [20, 70] },
  Cyan: { hue: [160, 190], sat: [60, 100], light: [40, 80] },
  Blue: { hue: [200, 240], sat: [60, 100], light: [20, 70] },
  Indigo: { hue: [245, 275], sat: [50, 90], light: [20, 60] },
  Violet: { hue: [275, 295], sat: [50, 90], light: [30, 70] },
  Purple: { hue: [300, 320], sat: [50, 100], light: [30, 70] },
  Pink: { hue: [320, 345], sat: [60, 100], light: [40, 80] },
  Brown: { hue: [10, 30], sat: [40, 70], light: [20, 45] },
};
...
export const fontMoreMenuItems = [
  { id: 1, title: "View details", icon: LuView },
  { id: 2, title: "Visit font site", icon: LuLink },
];

export const fontBestForItems = [
  "Branding",
  "Logos",
  "Magazines",
  "Banners",
